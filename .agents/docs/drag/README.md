...
| [`reviews/`](reviews/) | Reviews of the contracts and of each checkpoint, including the four Checkpoint C passes, [`checkpoint-c-1.md`](reviews/checkpoint-c-1.md) … [`checkpoint-c-4.md`](reviews/checkpoint-c-4.md). Pass 1 reopened D-33; pass 4 found the pointerless sortable losing its command destination and D-35 claiming a tier it did not have. |
