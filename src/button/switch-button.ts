...
import switchDefaultStyles from './default/switch.styles.ts?type=css' with { type: 'css' };
import mainElevatedStyles from './elevated/main.styles.ts?type=css' with { type: 'css' };
import switchElevatedStyles from './elevated/switch.styles.ts?type=css' with { type: 'css' };
import mainOutlinedStyles from './outlined/main.styles.ts?type=css' with { type: 'css' };
import switchOutlinedStyles from './outlined/switch.styles.ts?type=css' with { type: 'css' };
import mainSizeStyles from './size/main.styles.ts?type=css' with { type: 'css' };
import switchSizeStyles from './size/switch.styles.ts?type=css' with { type: 'css' };
import switchTonalStyles from './tonal/switch.styles.ts?type=css' with { type: 'css' };
