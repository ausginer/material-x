...
> MOVE  [K] begin(); pointerX/Y = sample; commit()
        ...
        [B] spec.activation.prepare(draft, scope) → HTMLElement    [prepare]
              ...
              footprint = box === visual ? boxPre : boxPre − boxPost
