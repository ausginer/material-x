...
| **Composition overhead** | 283 B, 2.4% — **221 B, 2.0% since D-146; 142 B, 1.3% since D-149** | The price of the architecture, stable across two feature additions and falling twice since: the per-key groups deleted `claim`, and dissolving both runtime aggregates took two modules out of every graph. The thing 03 asked to have weighed rather than removed |
