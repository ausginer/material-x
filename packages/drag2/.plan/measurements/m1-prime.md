...
>
> **M-6 ran 2026-08-20 and P-01 opens** — [`m6.md`](m6.md). On a stream Chromium itself coalesced, writes per rAF tick reach p95 3 and max 7; the sequential injector that returns p95 1 is recorded as inconclusive rather than as a bound, which is the reading this file's refusal was protecting.
