...
// **12 and 13 are holes and neither is ever reused** (D-130, D-41). A stage
// constant is a wire value in a consumer's compiled code, so repointing either
// number at a different meaning breaks that consumer silently. Adding a stage
...
// or not anyone remembers the file.
//
// 4, 5 and 8 were renamed without moving (D-74), and the same test asserts them
// as literals.
